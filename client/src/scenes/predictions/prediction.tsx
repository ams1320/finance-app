        ...
        <DashboardBox width="100%" height="100%" p="1rem" overflow="hidden">
            <FlexBetween m="1rem 2.5rem" gap=".3rem">
                <Box>
                    ...
                    <Typography variant="h6">charted revenue and predicted revenue based on a simple line regression model </Typography>
                </Box>
                <Button onClick={() => setIsPrediction(!isPrediction)}
                    sx={{ color: palette.grey[900], bgcolor: palette.grey[700], boxShadow: ".1rem .1rem .1rem .1rem rgba(0,0,0,.4)" }}>
                    show predicted revenue for next year
                </Button>
            </FlexBetween>
            <ResponsiveContainer width="100%" height="100%">
                <LineChart data={formattedData}
                    margin={{ top: 0, right: 75, left: 10, bottom: 130 }}>
